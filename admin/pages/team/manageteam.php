            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Manage Team</h1>
                            <a href="addteam.php" class="btn btn-primary mt-2">Add Team</a>
                        </div>
                        <div class="col-sm-6">
                 ...
                 while ($data= mysqli_fetch_array($result)){
                   ?>
                                            <tr>
                                                ...
                                                <td><img src="<?php echo "../../uploads/". $data['tm_img'];?>"
                                                        height="100px;" width="200px;"></td>
                                                <td><?php echo $data['tm_title'];?></td>
                                                <td><?php echo $data['tm_subtitle'];?></td>
