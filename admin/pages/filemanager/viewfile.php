                              ...
                              <div class="card-body ">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <input type="text" class="form-control" id="name" disabled name="filename" value="<?php echo $data['filename']; ?>" placeholder="File name">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Link:</label>
                                    <div class="input-group">
                                      ...
                                      <img src= "<?php echo "../uploads/".$data['filelink'];?>" height="200px;" width="200px;">
                                    </div>
                                </div>
                              </div>
                          </div>
